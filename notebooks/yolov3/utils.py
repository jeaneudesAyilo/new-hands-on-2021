...
import yolov4
from yolov4 import *
#from yolov3.configs import * ##sur colab ou sur l'environnement de base
#from yolov3.yolov4 import *  ##sur colab ou sur l'environnement de base
...
def detect_image(Yolo, image_path= '',type_image_path = "str_path", output_path = '', input_size=416, show=False, CLASSES=YOLO_COCO_CLASSES, score_threshold=0.3, iou_threshold=0.45, rectangle_colors=''):
    if type_image_path == "str_path":
        original_image      = cv2.imread(image_path)
        original_image      = cv2.cvtColor(original_image, cv2.COLOR_BGR2RGB)
        original_image      = cv2.cvtColor(original_image, cv2.COLOR_BGR2RGB)
    else:
        original_image      = Image.open(io.BytesIO(base64.b64decode(image_path)))
